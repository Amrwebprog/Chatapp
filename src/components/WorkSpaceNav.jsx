    ...
    <div className="col-12 h-25 p-3 d-flex flex-row justify-content-between mybg chatheader ">
      <div className=" d-flex flex-row flex-wrap gap-4 align-content-center  ">
        ...
        <div className="d-flex flex-column gap-1 text-center align-items-center ">
          {props.NavSelector.length > 0 && props.NavSelector[activeUser] ? (
            <h5 className="col-12 m-0">
              {props.NavSelector[activeUser].user_name}
            </h5>
          ) : (
            <h5 className="col-12 m-0">User not found</h5>
          )}
      ...
      <div className="d-flex flex-row align-items-center justify-content-center gap-3">
        <div className="">
          <FontAwesomeIcon className="text-danger" icon={faCamera} />
        </div>
        <div>
          <FontAwesomeIcon className="text-danger" icon={faImage} />
        </div>
        <div>
          <FontAwesomeIcon className="text-danger" icon={faGear} />
        </div>
        <div></div>
      </div>
    </div>
